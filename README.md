# توجه
بعد از تغییرات جدید سامانه سانسور جاعش که در پی هلاکت ضحاک رخ داد ، این متد نیز به فیض شهادت رسید. لذا اگر تنظیمات دیفالت نتوانست اتصال را به سرور برقرار کند بیش از حد درگیر نشوید. نسخه lite experiment میتواند نشان دهد که پکت ارسالی به مقصد میرسد یا خیر. همچنین نسخه go binary با تنظیمات دیفالت باید به راحتی وصل شود و اگر نشد باید نت را با ساقط کردن حکومت اشغالگر باز کرد. 
